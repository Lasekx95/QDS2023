...
export default function Notification() {
    return (
        <>
            ...
            {/* Dropdown Menu */}
            <div id="dropdownNotification" className="z-20 hidden w-full max-w-sm bg-white divide-y divide-gray-100 rounded shadow " aria-labelledby="dropdownNotificationButton">
                <div className="block px-4 py-2 font-medium text-center text-gray-700 bg-gray-50 ">
                    Notifications
                </div>
                <div className="divide-y divide-gray-100">
                    <a href="#" className="flex px-4 py-3 hover:bg-gray-100">
                        ...
                        <div className="w-full pl-3">
                            <div className="text-gray-500 text-sm mb-1.5 dark:text-gray-400">New message from <span className="font-semibold text-gray-900 ">Jese Leos</span>: "Hey, what's up? All set for the presentation?"</div>
                    ...
                    <a href="#" className="flex px-4 py-3 hover:bg-gray-100 ">
                        ...
                        <div className="w-full pl-3">
                            <div className="text-gray-500 text-sm mb-1.5 dark:text-gray-400"><span className="font-semibold text-gray-900 ">Joseph Mcfall</span> and <span className="font-medium text-gray-900 ">5 Vehicles</span> started transit.</div>
                    ...
                    <a href="#" className="flex px-4 py-3 hover:bg-gray-100 dark:hover:bg-gray-700">
                        ...
                        <div className="w-full pl-3">
                            <div className="text-gray-500 text-sm mb-1.5 dark:text-gray-400"><span className="font-semibold text-gray-900 ">Bonnie Green</span> and <span className="font-medium text-gray-900 dark:text-white">2 others</span> Submitted vehicle reports</div>
                    ...
                    <a href="#" className="flex px-4 py-3 hover:bg-gray-100 ">
                        ...
                        <div className="w-full pl-3">
                            <div className="text-gray-500 text-sm mb-1.5 dark:text-gray-400"><span className="font-semibold text-gray-900 ">Robert Brown</span> Vehicle ID#005 is due for scheduled maintenance.</div>
